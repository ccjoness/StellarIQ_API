...
class MarketDataService:
    ...
    async def _get_cached_or_fetch(self, cache_key: str, fetch_func, *args, **kwargs) -> Dict[str, Any]:
    ...
    async def get_stock_quote(self, symbol: str) -> Dict[str, Any]:
        ...
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.get_stock_quote,
            symbol
        )
    ...
    async def get_stock_daily(self, symbol: str, outputsize: str = "compact") -> Dict[str, Any]:
        ...
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.get_stock_daily,
            symbol,
            outputsize
        )
    ...
    async def search_symbol(self, keywords: str) -> Dict[str, Any]:
        ...
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.search_symbol,
            keywords
        )
    ...
    async def get_crypto_daily(self, symbol: str, market: str = "USD") -> Dict[str, Any]:
        ...
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.get_crypto_daily,
            symbol,
            market
        )
    ...
    async def get_crypto_intraday(self, symbol: str, market: str = "USD", interval: str = "5min") -> Dict[str, Any]:
        ...
        cache_key = f"crypto_intraday:symbol:{symbol}:market:{market}:interval:{interval}"
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.get_crypto_intraday,
            symbol,
            market,
            interval
        )
    ...
    async def get_crypto_weekly(self, symbol: str, market: str = "USD") -> Dict[str, Any]:
        ...
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.get_crypto_weekly,
            symbol,
            market
        )
    ...
    async def get_crypto_monthly(self, symbol: str, market: str = "USD") -> Dict[str, Any]:
        ...
        return await self._get_cached_or_fetch(
            cache_key,
            self.alpha_vantage.get_crypto_monthly,
            symbol,
            market
        )
