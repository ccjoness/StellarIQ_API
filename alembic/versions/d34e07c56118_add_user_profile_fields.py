...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('preferred_currency', sa.String(), nullable=False, server_default='USD'))
    ...
    op.execute("UPDATE users SET push_notifications = true WHERE push_notifications IS NULL")
